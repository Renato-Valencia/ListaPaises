...
public class MainActivity extends AppCompatActivity implements Asynchtask, AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView LS=(ListView)findViewById(R.id.lvnoticia);
        LS.setOnItemClickListener(this);
    }

    @Override
    public void processFinish(String result) throws JSONException {
        ArrayList<Noticia> lpais= new ArrayList<Noticia>();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        DownloadManager.Request request = new DownloadManager.Request(Uri.parse(((Noticia)parent.getItemAtPosition(position)).getUrl()));
